#!/usr/bin/env node
/**
 * Store eBay Discovery Macros to Unibrowse MongoDB
 *
 * Usage: node store-ebay-discovery-macros.js
 */

import { WebSocket } from 'ws';
import { ebayDiscoveryMacros } from '../ebay-discovery-macros.js';
...
async function sendMessage(type, payload) {
  return new Promise((resolve, reject) => {
    const id = `store-ebay-discovery-${++messageId}-${Date.now()}`;
...
async function storeMacros() {
  console.log('═══════════════════════════════════════════════════════════════');
  console.log('  STORING EBAY DISCOVERY MACROS');
  console.log(`  Total macros to store: ${ebayDiscoveryMacros.length}`);
  console.log('═══════════════════════════════════════════════════════════════\n');
  ...
  try {
    ...
    for (const macro of ebayDiscoveryMacros) {
    ...
    console.log(`  Total processed:         ${ebayDiscoveryMacros.length}`);
    console.log('═══════════════════════════════════════════════════════════════\n');
