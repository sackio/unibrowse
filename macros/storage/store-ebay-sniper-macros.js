#!/usr/bin/env node
/**
 * Store eBay Sniper Macros to Unibrowse MongoDB
 *
 * Usage: node store-ebay-sniper-macros.js
 */
...
async function sendMessage(type, payload) {
  return new Promise((resolve, reject) => {
    const id = `store-sniper-${++messageId}-${Date.now()}`;
...
async function storeMacros() {
  console.log('═══════════════════════════════════════════════════════════════');
  console.log('  STORING EBAY SNIPER MACROS');
  console.log(`  Total macros to store: ${ebaySniperMacros.length}`);
  console.log('═══════════════════════════════════════════════════════════════\n');
