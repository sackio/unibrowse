#!/usr/bin/env node
/**
 * Store CDN injection macros into Browser MCP database
 * Run: node /tmp/store-cdn-macros.js
 */

import { WebSocket } from 'ws';
import { cdnInjectionMacros } from './cdn-injection-macros.js';
...
async function sendMessage(type, payload) {
  return new Promise((resolve, reject) => {
    const id = `store-cdn-${++messageId}-${Date.now()}`;
...
async function storeMacros() {
  console.log('═══════════════════════════════════════════════════════════════');
  console.log('  STORING CDN INJECTION MACROS');
  console.log(`  Total macros to store: ${cdnInjectionMacros.length}`);
  console.log('═══════════════════════════════════════════════════════════════\n');
  ...
  try {
    ...
    for (const macro of cdnInjectionMacros) {
