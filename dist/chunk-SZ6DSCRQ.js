...
var getInteractions = {
  schema: {
    ...
    inputSchema: zodToJsonSchema8(GetInteractionsTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var pruneInteractions = {
  schema: {
    ...
    inputSchema: zodToJsonSchema8(PruneInteractionsTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var searchInteractions = {
  schema: {
    ...
    inputSchema: zodToJsonSchema8(SearchInteractionsTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var requestDemonstration = (snapshot2) => ({
  schema: {
    ...
    inputSchema: zodToJsonSchema9(RequestDemonstrationTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
import zodToJsonSchema10 from "zod-to-json-schema";
var snapshot = {
  schema: {
    name: SnapshotTool.shape.name.value,
    description: SnapshotTool.shape.description.value,
    inputSchema: zodToJsonSchema10(SnapshotTool.shape.arguments)
  },
  handle: async (context) => {
    try {
      await context.ensureAttached();
...
var click = {
  schema: {
    ...
    inputSchema: zodToJsonSchema10(ClickTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var drag = {
  schema: {
    ...
    inputSchema: zodToJsonSchema10(DragTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var hover = {
  schema: {
    ...
    inputSchema: zodToJsonSchema10(HoverTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var type = {
  schema: {
    ...
    inputSchema: zodToJsonSchema10(TypeTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var selectOption = {
  schema: {
    ...
    inputSchema: zodToJsonSchema10(SelectOptionTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var listTabs = {
  schema: {
    ...
    inputSchema: zodToJsonSchema11(ListTabsTool.shape.arguments)
  },
  handle: async (context) => {
    try {
      await context.ensureAttached();
...
var switchTab = {
  schema: {
    ...
    inputSchema: zodToJsonSchema11(SwitchTabTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var createTab = {
  schema: {
    ...
    inputSchema: zodToJsonSchema11(CreateTabTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var closeTab = {
  schema: {
    ...
    inputSchema: zodToJsonSchema11(CloseTabTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var requestUserAction = (snapshot2) => ({
  schema: {
    ...
    inputSchema: zodToJsonSchema12(RequestUserActionTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
