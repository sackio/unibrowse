  ...
  handle: async (context, params) => {
    try {
      ...
      if (result.tabs && result.tabs.length > 0) {
        const tabInfo = result.tabs.map((t) => `Tab ${t.tabId}: ${t.url}`).join(", ");
...
var package_default = {
  ...
  scripts: {
    ...
    "test:multi-tab": "node test-multi-tab.js",
    "test:window": "node test-create-window.js",
    "test:utility-macros": "node test-utility-macros.js",
    "test:advanced-macros": "node test-advanced-macros.js",
    "store:macros": "node store-utility-macros.js",
    "store:advanced-macros": "node store-advanced-macros.js"
  },
  dependencies: {
