...
var RequestDemonstrationTool = z.object({
  ...
  arguments: z.object({
    ...
    timeout: z.number().optional().describe("Maximum time to wait for the demonstration in seconds (default: 300 seconds / 5 minutes). Set higher for complex multi-step tasks.")
  })
});
...
var package_default = {
  ...
  scripts: {
    ...
    build: "tsup src/index.ts src/http-server.ts --format esm && shx chmod +x dist/*.js",
    prepare: "npm run build",
    watch: "tsup src/index.ts src/http-server.ts --format esm --watch",
    "dev:http": "nodemon",
