...
var queryDOM = {
  schema: {
    ...
    inputSchema: zodToJsonSchema4(QueryDOMTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var getVisibleText = {
  schema: {
    ...
    inputSchema: zodToJsonSchema4(GetVisibleTextTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var getComputedStyles = {
  schema: {
    ...
    inputSchema: zodToJsonSchema4(GetComputedStylesTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var checkVisibility = {
  schema: {
    ...
    inputSchema: zodToJsonSchema4(CheckVisibilityTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var getAttributes = {
  schema: {
    ...
    inputSchema: zodToJsonSchema4(GetAttributesTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var countElements = {
  schema: {
    ...
    inputSchema: zodToJsonSchema4(CountElementsTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var getPageMetadata = {
  schema: {
    ...
    inputSchema: zodToJsonSchema4(GetPageMetadataTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var getFilteredAriaTree = {
  schema: {
    ...
    inputSchema: zodToJsonSchema4(GetFilteredAriaTreeTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var findByText = {
  schema: {
    ...
    inputSchema: zodToJsonSchema4(FindByTextTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var getFormValues = {
  schema: {
    ...
    inputSchema: zodToJsonSchema4(GetFormValuesTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var checkElementState = {
  schema: {
    ...
    inputSchema: zodToJsonSchema4(CheckElementStateTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
// src/tools/forms.ts
import zodToJsonSchema5 from "zod-to-json-schema";
var fillForm = {
  schema: {
    name: FillFormTool.shape.name.value,
    description: FillFormTool.shape.description.value,
    inputSchema: zodToJsonSchema5(FillFormTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var submitForm = {
  schema: {
    ...
    inputSchema: zodToJsonSchema5(SubmitFormTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var getInteractions = {
  schema: {
    ...
    inputSchema: zodToJsonSchema6(GetInteractionsTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var pruneInteractions = {
  schema: {
    ...
    inputSchema: zodToJsonSchema6(PruneInteractionsTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var searchInteractions = {
  schema: {
    ...
    inputSchema: zodToJsonSchema6(SearchInteractionsTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var requestDemonstration = (snapshot2) => ({
  schema: {
    ...
    inputSchema: zodToJsonSchema7(RequestDemonstrationTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var snapshot = {
  schema: {
    ...
    inputSchema: zodToJsonSchema8(SnapshotTool.shape.arguments)
  },
  handle: async (context) => {
    try {
      await context.ensureAttached();
...
var click = {
  schema: {
    ...
    inputSchema: zodToJsonSchema8(ClickTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var drag = {
  schema: {
    ...
    inputSchema: zodToJsonSchema8(DragTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var hover = {
  schema: {
    ...
    inputSchema: zodToJsonSchema8(HoverTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var type = {
  schema: {
    ...
    inputSchema: zodToJsonSchema8(TypeTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var selectOption = {
  schema: {
    ...
    inputSchema: zodToJsonSchema8(SelectOptionTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var listTabs = {
  schema: {
    ...
    inputSchema: zodToJsonSchema9(ListTabsTool.shape.arguments)
  },
  handle: async (context) => {
    try {
      await context.ensureAttached();
...
var switchTab = {
  schema: {
    ...
    inputSchema: zodToJsonSchema9(SwitchTabTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var createTab = {
  schema: {
    ...
    inputSchema: zodToJsonSchema9(CreateTabTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var closeTab = {
  schema: {
    ...
    inputSchema: zodToJsonSchema9(CloseTabTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var requestUserAction = (snapshot2) => ({
  schema: {
    ...
    inputSchema: zodToJsonSchema10(RequestUserActionTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
