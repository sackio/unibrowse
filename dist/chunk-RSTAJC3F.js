...
async function createServerWithTools(options) {
  ...
  async function handleBrowserMessage(ws, message) {
    const { id, type: type2, payload, result, error } = message;
    if (type2 === "EXTENSION_REGISTER") {
      console.log(`[Server] Extension registered, storing as primary browser connection`);
      globalContext.ws = ws;
      return;
    }
    if (!type2 && (result !== void 0 || error !== void 0)) {
      console.log(`[Server] Received response from extension: ${id}`);
      return;
    }
    if (!type2) {
    ...
    try {
      ...
      ws.send(JSON.stringify({ id, result: toolResult }));
    } catch (error2) {
      console.error(`[Server] Tool execution error:`, error2);
      ws.send(JSON.stringify({ id, error: String(error2) }));
    }
  }
...
var requestDemonstration = (snapshot2) => ({
  schema: {
    ...
    inputSchema: zodToJsonSchema13(RequestDemonstrationTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var snapshot = {
  schema: {
    ...
    inputSchema: zodToJsonSchema14(SnapshotTool.shape.arguments)
  },
  handle: async (context) => {
    try {
      await context.ensureAttached();
...
var click = {
  schema: {
    ...
    inputSchema: zodToJsonSchema14(ClickTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var drag = {
  schema: {
    ...
    inputSchema: zodToJsonSchema14(DragTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var hover = {
  schema: {
    ...
    inputSchema: zodToJsonSchema14(HoverTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var type = {
  schema: {
    ...
    inputSchema: zodToJsonSchema14(TypeTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var selectOption = {
  schema: {
    ...
    inputSchema: zodToJsonSchema14(SelectOptionTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var getVersion = {
  schema: {
    ...
    inputSchema: zodToJsonSchema15(GetVersionTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var getSystemInfo = {
  schema: {
    ...
    inputSchema: zodToJsonSchema15(GetSystemInfoTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var getBrowserInfo = {
  schema: {
    ...
    inputSchema: zodToJsonSchema15(GetBrowserInfoTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
// src/tools/tabs.ts
import zodToJsonSchema16 from "zod-to-json-schema";
var listTabs = {
  schema: {
    name: ListTabsTool.shape.name.value,
    description: ListTabsTool.shape.description.value,
    inputSchema: zodToJsonSchema16(ListTabsTool.shape.arguments)
  },
  handle: async (context) => {
    try {
      await context.ensureAttached();
...
var switchTab = {
  schema: {
    ...
    inputSchema: zodToJsonSchema16(SwitchTabTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var createTab = {
  schema: {
    ...
    inputSchema: zodToJsonSchema16(CreateTabTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var closeTab = {
  schema: {
    ...
    inputSchema: zodToJsonSchema16(CloseTabTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var requestUserAction = (snapshot2) => ({
  schema: {
    ...
    inputSchema: zodToJsonSchema17(RequestUserActionTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
