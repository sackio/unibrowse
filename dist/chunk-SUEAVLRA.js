...
var navigate = (snapshot2) => ({
  schema: {
    ...
    inputSchema: zodToJsonSchema2(NavigateTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var goBack = (snapshot2) => ({
  schema: {
    ...
    inputSchema: zodToJsonSchema2(GoBackTool.shape.arguments)
  },
...
var goForward = (snapshot2) => ({
  schema: {
    ...
    inputSchema: zodToJsonSchema2(GoForwardTool.shape.arguments)
  },
  handle: async (context) => {
    try {
      await context.ensureAttached();
...
var wait = {
  schema: {
    ...
    inputSchema: zodToJsonSchema2(WaitTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var pressKey = {
  schema: {
    ...
    inputSchema: zodToJsonSchema2(PressKeyTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var scroll = {
  schema: {
    ...
    inputSchema: zodToJsonSchema2(ScrollTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var scrollToElement = {
  schema: {
    ...
    inputSchema: zodToJsonSchema2(ScrollToElementTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var getCookies = {
  schema: {
    ...
    inputSchema: zodToJsonSchema3(GetCookiesTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var setCookie = {
  schema: {
    ...
    inputSchema: zodToJsonSchema3(SetCookieTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var deleteCookie = {
  schema: {
    ...
    inputSchema: zodToJsonSchema3(DeleteCookieTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var clearCookies = {
  schema: {
    ...
    inputSchema: zodToJsonSchema3(ClearCookiesTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var getConsoleLogs = {
  schema: {
    ...
    inputSchema: zodToJsonSchema4(GetConsoleLogsTool.shape.arguments)
  },
...
var screenshot = {
  schema: {
    ...
    inputSchema: zodToJsonSchema4(ScreenshotTool.shape.arguments)
  },
  handle: async (context, _params) => {
    try {
      await context.ensureAttached();
...
var evaluate = {
  schema: {
    ...
    inputSchema: zodToJsonSchema4(EvaluateTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var getNetworkLogs = {
  schema: {
    ...
    inputSchema: zodToJsonSchema4(GetNetworkLogsTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var downloadFile = {
  schema: {
    ...
    inputSchema: zodToJsonSchema5(DownloadFileTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var getDownloads = {
  schema: {
    ...
    inputSchema: zodToJsonSchema5(GetDownloadsTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var cancelDownload = {
  schema: {
    ...
    inputSchema: zodToJsonSchema5(CancelDownloadTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var openDownload = {
  schema: {
    ...
    inputSchema: zodToJsonSchema5(OpenDownloadTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var queryDOM = {
  schema: {
    ...
    inputSchema: zodToJsonSchema6(QueryDOMTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var getVisibleText = {
  schema: {
    ...
    inputSchema: zodToJsonSchema6(GetVisibleTextTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var getComputedStyles = {
  schema: {
    ...
    inputSchema: zodToJsonSchema6(GetComputedStylesTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var checkVisibility = {
  schema: {
    ...
    inputSchema: zodToJsonSchema6(CheckVisibilityTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var getAttributes = {
  schema: {
    ...
    inputSchema: zodToJsonSchema6(GetAttributesTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var countElements = {
  schema: {
    ...
    inputSchema: zodToJsonSchema6(CountElementsTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var getPageMetadata = {
  schema: {
    ...
    inputSchema: zodToJsonSchema6(GetPageMetadataTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var getFilteredAriaTree = {
  schema: {
    ...
    inputSchema: zodToJsonSchema6(GetFilteredAriaTreeTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var findByText = {
  schema: {
    ...
    inputSchema: zodToJsonSchema6(FindByTextTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var getFormValues = {
  schema: {
    ...
    inputSchema: zodToJsonSchema6(GetFormValuesTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var checkElementState = {
  schema: {
    ...
    inputSchema: zodToJsonSchema6(CheckElementStateTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var fillForm = {
  schema: {
    ...
    inputSchema: zodToJsonSchema7(FillFormTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var submitForm = {
  schema: {
    ...
    inputSchema: zodToJsonSchema7(SubmitFormTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var searchHistory = {
  schema: {
    ...
    inputSchema: zodToJsonSchema8(SearchHistoryTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var getHistoryVisits = {
  schema: {
    ...
    inputSchema: zodToJsonSchema8(GetHistoryVisitsTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var deleteHistory = {
  schema: {
    ...
    inputSchema: zodToJsonSchema8(DeleteHistoryTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var clearHistory = {
  schema: {
    ...
    inputSchema: zodToJsonSchema8(ClearHistoryTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var getInteractions = {
  schema: {
    ...
    inputSchema: zodToJsonSchema9(GetInteractionsTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var pruneInteractions = {
  schema: {
    ...
    inputSchema: zodToJsonSchema9(PruneInteractionsTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var searchInteractions = {
  schema: {
    ...
    inputSchema: zodToJsonSchema9(SearchInteractionsTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var getNetworkState = {
  schema: {
    ...
    inputSchema: zodToJsonSchema10(GetNetworkStateTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var setNetworkConditions = {
  schema: {
    ...
    inputSchema: zodToJsonSchema10(SetNetworkConditionsTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var clearCache = {
  schema: {
    ...
    inputSchema: zodToJsonSchema10(ClearCacheTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var requestDemonstration = (snapshot2) => ({
  schema: {
    ...
    inputSchema: zodToJsonSchema11(RequestDemonstrationTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
import zodToJsonSchema12 from "zod-to-json-schema";
var snapshot = {
  schema: {
    name: SnapshotTool.shape.name.value,
    description: SnapshotTool.shape.description.value,
    inputSchema: zodToJsonSchema12(SnapshotTool.shape.arguments)
  },
  handle: async (context) => {
    try {
      await context.ensureAttached();
...
var click = {
  schema: {
    ...
    inputSchema: zodToJsonSchema12(ClickTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var drag = {
  schema: {
    ...
    inputSchema: zodToJsonSchema12(DragTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var hover = {
  schema: {
    ...
    inputSchema: zodToJsonSchema12(HoverTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var type = {
  schema: {
    ...
    inputSchema: zodToJsonSchema12(TypeTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var selectOption = {
  schema: {
    ...
    inputSchema: zodToJsonSchema12(SelectOptionTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var getVersion = {
  schema: {
    ...
    inputSchema: zodToJsonSchema13(GetVersionTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var getSystemInfo = {
  schema: {
    ...
    inputSchema: zodToJsonSchema13(GetSystemInfoTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var getBrowserInfo = {
  schema: {
    ...
    inputSchema: zodToJsonSchema13(GetBrowserInfoTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
// src/tools/tabs.ts
import zodToJsonSchema14 from "zod-to-json-schema";
var listTabs = {
  schema: {
    name: ListTabsTool.shape.name.value,
    description: ListTabsTool.shape.description.value,
    inputSchema: zodToJsonSchema14(ListTabsTool.shape.arguments)
  },
  handle: async (context) => {
    try {
      await context.ensureAttached();
...
var switchTab = {
  schema: {
    ...
    inputSchema: zodToJsonSchema14(SwitchTabTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var createTab = {
  schema: {
    ...
    inputSchema: zodToJsonSchema14(CreateTabTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var closeTab = {
  schema: {
    ...
    inputSchema: zodToJsonSchema14(CloseTabTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
import { zodToJsonSchema as zodToJsonSchema15 } from "zod-to-json-schema";
var requestUserAction = (snapshot2) => ({
  schema: {
    ...
    inputSchema: zodToJsonSchema15(RequestUserActionTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
