...
var queryDOM = {
  schema: {
    ...
    inputSchema: zodToJsonSchema7(QueryDOMTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var getVisibleText = {
  schema: {
    ...
    inputSchema: zodToJsonSchema7(GetVisibleTextTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var getComputedStyles = {
  schema: {
    ...
    inputSchema: zodToJsonSchema7(GetComputedStylesTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var checkVisibility = {
  schema: {
    ...
    inputSchema: zodToJsonSchema7(CheckVisibilityTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var getAttributes = {
  schema: {
    ...
    inputSchema: zodToJsonSchema7(GetAttributesTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var countElements = {
  schema: {
    ...
    inputSchema: zodToJsonSchema7(CountElementsTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var getPageMetadata = {
  schema: {
    ...
    inputSchema: zodToJsonSchema7(GetPageMetadataTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var getFilteredAriaTree = {
  schema: {
    ...
    inputSchema: zodToJsonSchema7(GetFilteredAriaTreeTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var findByText = {
  schema: {
    ...
    inputSchema: zodToJsonSchema7(FindByTextTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var getFormValues = {
  schema: {
    ...
    inputSchema: zodToJsonSchema7(GetFormValuesTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var checkElementState = {
  schema: {
    ...
    inputSchema: zodToJsonSchema7(CheckElementStateTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var fillForm = {
  schema: {
    ...
    inputSchema: zodToJsonSchema8(FillFormTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var submitForm = {
  schema: {
    ...
    inputSchema: zodToJsonSchema8(SubmitFormTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var searchHistory = {
  schema: {
    ...
    inputSchema: zodToJsonSchema9(SearchHistoryTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var getHistoryVisits = {
  schema: {
    ...
    inputSchema: zodToJsonSchema9(GetHistoryVisitsTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var deleteHistory = {
  schema: {
    ...
    inputSchema: zodToJsonSchema9(DeleteHistoryTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var clearHistory = {
  schema: {
    ...
    inputSchema: zodToJsonSchema9(ClearHistoryTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var getInteractions = {
  schema: {
    ...
    inputSchema: zodToJsonSchema10(GetInteractionsTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var pruneInteractions = {
  schema: {
    ...
    inputSchema: zodToJsonSchema10(PruneInteractionsTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var searchInteractions = {
  schema: {
    ...
    inputSchema: zodToJsonSchema10(SearchInteractionsTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var getNetworkState = {
  schema: {
    ...
    inputSchema: zodToJsonSchema11(GetNetworkStateTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var setNetworkConditions = {
  schema: {
    ...
    inputSchema: zodToJsonSchema11(SetNetworkConditionsTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var clearCache = {
  schema: {
    ...
    inputSchema: zodToJsonSchema11(ClearCacheTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var requestDemonstration = (snapshot2) => ({
  schema: {
    ...
    inputSchema: zodToJsonSchema12(RequestDemonstrationTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
