...
var getCookies = {
  schema: {
    ...
    inputSchema: zodToJsonSchema2(GetCookiesTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var setCookie = {
  schema: {
    ...
    inputSchema: zodToJsonSchema2(SetCookieTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var deleteCookie = {
  schema: {
    ...
    inputSchema: zodToJsonSchema2(DeleteCookieTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var clearCookies = {
  schema: {
    ...
    inputSchema: zodToJsonSchema2(ClearCookiesTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var getConsoleLogs = {
  schema: {
    ...
    inputSchema: zodToJsonSchema3(GetConsoleLogsTool.shape.arguments)
  },
...
var screenshot = {
  schema: {
    ...
    inputSchema: zodToJsonSchema3(ScreenshotTool.shape.arguments)
  },
  handle: async (context, _params) => {
    try {
      await context.ensureAttached();
...
var evaluate = {
  schema: {
    ...
    inputSchema: zodToJsonSchema3(EvaluateTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var getNetworkLogs = {
  schema: {
    ...
    inputSchema: zodToJsonSchema3(GetNetworkLogsTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var downloadFile = {
  schema: {
    ...
    inputSchema: zodToJsonSchema4(DownloadFileTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var getDownloads = {
  schema: {
    ...
    inputSchema: zodToJsonSchema4(GetDownloadsTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var cancelDownload = {
  schema: {
    ...
    inputSchema: zodToJsonSchema4(CancelDownloadTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var openDownload = {
  schema: {
    ...
    inputSchema: zodToJsonSchema4(OpenDownloadTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var queryDOM = {
  schema: {
    ...
    inputSchema: zodToJsonSchema5(QueryDOMTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var getVisibleText = {
  schema: {
    ...
    inputSchema: zodToJsonSchema5(GetVisibleTextTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var getComputedStyles = {
  schema: {
    ...
    inputSchema: zodToJsonSchema5(GetComputedStylesTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var checkVisibility = {
  schema: {
    ...
    inputSchema: zodToJsonSchema5(CheckVisibilityTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var getAttributes = {
  schema: {
    ...
    inputSchema: zodToJsonSchema5(GetAttributesTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var countElements = {
  schema: {
    ...
    inputSchema: zodToJsonSchema5(CountElementsTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var getPageMetadata = {
  schema: {
    ...
    inputSchema: zodToJsonSchema5(GetPageMetadataTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var getFilteredAriaTree = {
  schema: {
    ...
    inputSchema: zodToJsonSchema5(GetFilteredAriaTreeTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var findByText = {
  schema: {
    ...
    inputSchema: zodToJsonSchema5(FindByTextTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var getFormValues = {
  schema: {
    ...
    inputSchema: zodToJsonSchema5(GetFormValuesTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var checkElementState = {
  schema: {
    ...
    inputSchema: zodToJsonSchema5(CheckElementStateTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
// src/tools/forms.ts
import zodToJsonSchema6 from "zod-to-json-schema";
var fillForm = {
  schema: {
    name: FillFormTool.shape.name.value,
    description: FillFormTool.shape.description.value,
    inputSchema: zodToJsonSchema6(FillFormTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var submitForm = {
  schema: {
    ...
    inputSchema: zodToJsonSchema6(SubmitFormTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var getInteractions = {
  schema: {
    ...
    inputSchema: zodToJsonSchema7(GetInteractionsTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var pruneInteractions = {
  schema: {
    ...
    inputSchema: zodToJsonSchema7(PruneInteractionsTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var searchInteractions = {
  schema: {
    ...
    inputSchema: zodToJsonSchema7(SearchInteractionsTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var requestDemonstration = (snapshot2) => ({
  schema: {
    ...
    inputSchema: zodToJsonSchema8(RequestDemonstrationTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var snapshot = {
  schema: {
    ...
    inputSchema: zodToJsonSchema9(SnapshotTool.shape.arguments)
  },
  handle: async (context) => {
    try {
      await context.ensureAttached();
...
var click = {
  schema: {
    ...
    inputSchema: zodToJsonSchema9(ClickTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var drag = {
  schema: {
    ...
    inputSchema: zodToJsonSchema9(DragTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var hover = {
  schema: {
    ...
    inputSchema: zodToJsonSchema9(HoverTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var type = {
  schema: {
    ...
    inputSchema: zodToJsonSchema9(TypeTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var selectOption = {
  schema: {
    ...
    inputSchema: zodToJsonSchema9(SelectOptionTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var listTabs = {
  schema: {
    ...
    inputSchema: zodToJsonSchema10(ListTabsTool.shape.arguments)
  },
  handle: async (context) => {
    try {
      await context.ensureAttached();
...
var switchTab = {
  schema: {
    ...
    inputSchema: zodToJsonSchema10(SwitchTabTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var createTab = {
  schema: {
    ...
    inputSchema: zodToJsonSchema10(CreateTabTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var closeTab = {
  schema: {
    ...
    inputSchema: zodToJsonSchema10(CloseTabTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var requestUserAction = (snapshot2) => ({
  schema: {
    ...
    inputSchema: zodToJsonSchema11(RequestUserActionTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
