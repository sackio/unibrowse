...
var listTabs = {
  schema: {
    ...
    inputSchema: zodToJsonSchema12(ListTabsTool.shape.arguments)
  },
  handle: async (context) => {
    try {
      await context.ensureAttached();
...
var switchTab = {
  schema: {
    ...
    inputSchema: zodToJsonSchema12(SwitchTabTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var createTab = {
  schema: {
    ...
    inputSchema: zodToJsonSchema12(CreateTabTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var closeTab = {
  schema: {
    ...
    inputSchema: zodToJsonSchema12(CloseTabTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
...
var requestUserAction = (snapshot2) => ({
  schema: {
    ...
    inputSchema: zodToJsonSchema13(RequestUserActionTool.shape.arguments)
  },
  handle: async (context, params) => {
    try {
      await context.ensureAttached();
